...
OutputDir=.
OutputBaseFilename=gumpad-3.0.3.5
VersionInfoVersion=3.0.3.5
...
Source: "..\publish\GumPadWordAddIn_1_0_3_5.zip"; DestDir: "{app}\Office2007WordAddIn"; Flags: ignoreversion
