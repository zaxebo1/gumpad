...
OutputDir=.
OutputBaseFilename=gumpad-3.0.3.6
VersionInfoVersion=3.0.3.6
...
Source: "..\publish\GumPadWordAddIn_1_0_3_6.zip"; DestDir: "{app}\Office2007WordAddIn"; Flags: ignoreversion
